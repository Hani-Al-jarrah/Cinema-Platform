...
- Create Angular project with ng: `ng new coreapiproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`coreapiproject.client.esproj`).
